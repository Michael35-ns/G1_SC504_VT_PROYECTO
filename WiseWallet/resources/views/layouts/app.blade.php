...
<body class="bg-gray-100">
    ...
    <aside class="bg-gray-900 custom-aside">
        <div class="sidebar w-[4.15rem] overflow-hidden border-r border-gray-700 hover:w-60 hover:bg-gray-900 hover:shadow-lg transition-all duration-300">
            <div class="flex h-screen flex-col justify-between pt-2 pb-6">
                <div>
                    ...
                    <ul class="mt-6 space-y-2 tracking-wide">
                        <li class="min-w-max">
                            <a href="#" aria-label="home" class="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-white hover:bg-gray-800 transition-all duration-300">
                        ...
                        <li class="min-w-max">
                            <a href="#" class="bg group flex items-center space-x-4 rounded-full px-4 py-3 text-white hover:bg-gray-800 transition-all duration-300">
