...
@section('contenido')
    <section class="content_login flex flex-col items-center py-10">
        <div class="contenedor-imagen mb-8">
            <img class="imagen" src="https://economipedia.com/wp-content/uploads/Finanzas.jpg" alt="login" width="650px"
                height="650px" />
        </div>
        <div class="container-login">
            ...
            <br>
            <a style="color:white;" href="{{ route('register') }}" class="block mt-4 text-center">No tienes una cuenta
                creada?</a>
